...
export const Purchase = () => {
  ...
  return (
    <section
      id="purchase"
      className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-white to-orange-50/60 py-24 text-slate-900"
    >
        ...
        >
          ...
          <div className="mb-8">
            ...
            <div className="flex items-baseline justify-center gap-2">
              ...
              <span className="text-2xl font-bold text-slate-400 line-through decoration-2 decoration-rose-400">
                100
              </span>
            </div>
          </div>
